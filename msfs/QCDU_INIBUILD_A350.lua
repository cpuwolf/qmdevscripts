...
uluaLog("QCDU-A320 for Inibuild A350")
...
qcdua:CfgRpn(22, '1 (>L:INI_MCDU1_SURV)')
...
qcdua:CfgRpn(66, '1 (>L:INI_MCDU1_ENTER)') -- OVFY is replaced by ENTER
qcdua:CfgRpn(67, '1 (>L:INI_MCDU1_SLASH)')
qcdua:CfgRpn(68, '1 (>L:INI_MCDU1_CLR)')

qcdua:CfgVal(69, "B:AIRLINER_CPT_MCDU_BRT", 2, 1)
qcdua:CfgVal(70, "B:AIRLINER_CPT_MCDU_BRT", 0, 1)
...
qcdua:GetBkl("(L:INI_CKPT_LT_INTEG, Percent)", 0.3)
...
uluaAddDoLoop("CDU_INIA350_LED_UPD()")
