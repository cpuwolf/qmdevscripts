...
-- tested by Wei Shuai <cpuwolf@gmail.com> 2022-03-16 for JD320-V3.7R1
-- tested by Wei Shuai <cpuwolf@gmail.com> 2023-09-25 for JD320-V3.8R1
-- ######################  Edit part  #####################
...
if PLANE_ICAO ~= "A330" then
    if PLANE_ICAO ~= "A320" or PLANE_TAILNUMBER ~= "A320" then
        return
    end
end
...
if PLANE_ICAO ~= "A320" then
    dr_qfcu_c_baro = iDataRef:New("sim/cockpit/misc/barometer_setting")
    dr_qfcu_c_baro_hpa = iDataRef:New("sim/custom/xap/ind_baro_hpa")
    dr_qfcu_f_baro = iDataRef:New("sim/cockpit/misc/barometer_setting")
else
    dr_qfcu_c_baro = iDataRef:New("jd/ind_baro_inhg")
    dr_qfcu_c_baro_hpa = iDataRef:New("jd/ind_baro_hpa")
    dr_qfcu_f_baro = iDataRef:New("sim/cockpit/misc/barometer_setting")
end
...
if PLANE_ICAO ~= "A320" then
    dr_qfcu_fcu_light = iDataRef:New("sim/custom/xap/intlight/int_pan_ped_kn") -- 0~1
else
    dr_qfcu_fcu_light = iDataRef:New("sim/custom/xap/intlight/int_pan_ped_lt") -- 0~1
end
